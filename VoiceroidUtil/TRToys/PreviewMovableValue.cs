...
namespace RucheHome.AviUtl.ExEdit
{
    ...
    public class PreviewMovableValue<TConstants> : BindableBase, IMovableValue, ICloneable
        where TConstants : IMovableValueConstants, new()
    {
        ...
        public static PreviewMovableValue<TConstants> Parse(string value) =>
        ...
        public static bool TryParse(string value, out PreviewMovableValue<TConstants> result)
        {
            result = null;
            ...
            if (vals.Length == 1)
            {
                result = new PreviewMovableValue<TConstants>(begin);
            }
            else if (vals.Length == 3 || vals.Length == 4)
            {
                ...
                result =
                    new PreviewMovableValue<TConstants>(
                        begin,
                        end,
                        moveMode,
                        accel,
        ...
        /// コンストラクタ。
        /// </summary>
        public PreviewMovableValue() : this(ThisConstants.DefaultValue)
        {
        }
        ...
        public PreviewMovableValue(decimal value) : this(value, value, MoveMode.None)
        {
        }
        ...
        public PreviewMovableValue(PreviewMovableValue<TConstants> src)
        {
            if (src == null)
            {
        ...
        public PreviewMovableValue<TConstants> Clone() => new PreviewMovableValue<TConstants>(this);
